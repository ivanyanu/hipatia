...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './genero.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GENERO_LIST actions', async () => {
    ...
    it('dispatches FETCH_GENERO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GENERO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GENERO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GENERO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GENERO actions', async () => {
      const expectedActions = [
        {
