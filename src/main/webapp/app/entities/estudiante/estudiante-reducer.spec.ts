...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ESTUDIANTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ESTUDIANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ESTUDIANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ESTUDIANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ESTUDIANTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ESTUDIANTE actions', async () => {
      const expectedActions = [
        {
