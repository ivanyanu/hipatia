...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './prestamo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRESTAMO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRESTAMO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRESTAMO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRESTAMO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRESTAMO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRESTAMO actions', async () => {
      const expectedActions = [
        {
