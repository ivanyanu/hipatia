...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './libro.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LIBRO_LIST actions', async () => {
    ...
    it('dispatches FETCH_LIBRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LIBRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LIBRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LIBRO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LIBRO actions', async () => {
      const expectedActions = [
        {
