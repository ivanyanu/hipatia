...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ejemplar.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EJEMPLAR_LIST actions', async () => {
    ...
    it('dispatches FETCH_EJEMPLAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EJEMPLAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EJEMPLAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EJEMPLAR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EJEMPLAR actions', async () => {
      const expectedActions = [
        {
