...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './editorial.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EDITORIAL_LIST actions', async () => {
    ...
    it('dispatches FETCH_EDITORIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EDITORIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EDITORIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EDITORIAL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EDITORIAL actions', async () => {
      const expectedActions = [
        {
