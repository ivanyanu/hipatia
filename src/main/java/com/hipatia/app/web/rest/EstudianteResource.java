...
/**
 * REST controller for managing {@link com.hipatia.app.domain.Estudiante}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Estudiante> result = estudianteRepository
            ...
            .map(existingEstudiante -> {
                if (estudiante.getNombreEstudiante() != null) {
                    existingEstudiante.setNombreEstudiante(estudiante.getNombreEstudiante());
                }
                if (estudiante.getApellidoEstudiante() != null) {
                    existingEstudiante.setApellidoEstudiante(estudiante.getApellidoEstudiante());
                }
                ...
                if (estudiante.getLegajo() != null) {
                    existingEstudiante.setLegajo(estudiante.getLegajo());
                }
